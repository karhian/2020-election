...
Figure \@ref(fig:age1) shows something 

```{r age1, fig.cap = "Frequency of Age Groups for Population Data", echo = FALSE, fig.width=8, fig.height=4}
dataforgraph1 <- read.csv("../cleaned data/poststratification_cleaned.csv")
graph1 <- dataforgraph1 %>% 
  ggplot()+ geom_bar(aes(x=age_groups, fill = age_groups)) + 
  labs(x = "Age Groups", 
       y = "Number of People") 
graph1
```
...
Figure \@ref(fig:age2)  aslo shows something 

```{r age2, fig.cap = "Frequency of Age Groups for Survery Data", echo = FALSE, fig.width=8, fig.height=4}
dataforgraph2 <- read.csv("../cleaned data/survey_cleaned.csv")
graph2 <- dataforgraph2 %>% 
  ggplot()+ geom_bar(aes(x=age_groups, fill = age_groups)) + 
  labs(x = "Age Groups", 
       y = "Number of People") 
graph2
```
```{r table1, fig.cap = "voting intention 2020", echo = FALSE, fig.width=8, fig.height=4}
#install.packages("scales")

table1 <- table(dataforgraph2$vote_2020)
table1
```
